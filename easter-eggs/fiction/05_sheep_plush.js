/* 05_sheep_plush.js — assembles the two-panel sheep plate as the cursor moves.
   ...
   and only ever moves forward — so the live sheep and its plush twin slowly
   come together as you explore the page and then stay drawn. Mirrors
   01_orbital_station.js. */
(function () {
  "use strict";
  ...
  var SVG_URL = "05_sheep_plush.svg";
  ...
  if (coarse && hint) hint.textContent = "drag across the screen to draft the sheep";
  ...
  fetch(SVG_URL)
    ...
    .catch(function () {
      sheet.innerHTML = '<p style="color:#b694dd;font-size:13px">the drawing ' +
  ...
  function init(svg) {
    ...
    function apply(p) {
      ...
      if (pctEl) pctEl.textContent = p >= 0.999 ? "drawn ✓" : pct + "%";
