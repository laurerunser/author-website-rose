/* 02_barnacle_goose.js — assembles the barnacle-goose field plate as the cursor moves.
   ...
   and only ever moves forward — so the goose slowly comes together as you
   explore the page and then stays drawn. Mirrors 01_orbital_station.js. */
(function () {
  "use strict";
  ...
  var SVG_URL = "02_barnacle_goose.svg";
  ...
  if (coarse && hint) hint.textContent = "drag across the screen to draft the goose";
  ...
  fetch(SVG_URL)
    ...
    .catch(function () {
      sheet.innerHTML = '<p style="color:#74c98a;font-size:13px">the drawing ' +
